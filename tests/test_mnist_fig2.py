...
mnist_fig2.py is now a thin CLI wrapper over the notebooks/toy/ package. This
test only checks the wrapper's legacy entry points still produce well-formed
curves; the reusable building blocks (init variants, label splits, FedProx
drift correction, server momentum, MethodConfig) are tested against the package
directly in tests/test_toy_components.py.
"""
